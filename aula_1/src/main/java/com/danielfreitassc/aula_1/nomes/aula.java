package com.danielfreitassc.aula_1.nomes;
...
public class aula {
    public static void main(String[] args) throws Exception{
        ...
        String listaDeIdades = retornaListaDaURI("https://venson.net.br/resources/data/nomes.txt");
        String idade = retornaIndiceAleatorio(listaDeIdades);
